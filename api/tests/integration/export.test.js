...
describe('Export Integration Tests', () => {
    ...
    test('GET /export/excel debe retornar archivo XLSX', async () => {
        ...
        expect(res.header['content-disposition']).toContain('attachment; filename=asignaciones.xlsx');
    });
    ...
    test('GET /export/ics debe retornar archivo ICS', async () => {
        ...
        expect(res.header['content-disposition']).toContain('attachment; filename=asignaciones.ics');
